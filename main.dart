...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_selectedIndex == 0) {
      ...
      bodyContent = SearchScreen(onBackTap: () => _onItemTapped(0));
    } else if (_selectedIndex == 2) {
      bodyContent = CreateEventScreen(onBackTap: () => _onItemTapped(0));
    } else {
                ...
                child: Container(
                  ...
                  child: const TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: "Search",
                      hintStyle: AppTextStyles.labelLarge, // Using reusable style
        ...
        children: [
          ...
          Column(
            children: [
              ElevatedButton(
                onPressed: () {
                  print("Detailed event page button pressed"); //my friends going to add that
                },
                style: ElevatedButton.styleFrom(
